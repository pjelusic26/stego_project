...
image_path = str(path.parents[1])+'/stego_project/test_set/coated/orig/img_01_590.tif'
imgName = '/home/zgebac26/python/stego_project/test_set/coated/orig/img_01_590_psnr_15_20.tif'
...
factor = stego_object.implementation_strength('A', channel, (15, 20), 200, 'MEDIUM')
